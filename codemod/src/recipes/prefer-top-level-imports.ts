...
const packageName = "@com.mgmtp.a12.diagrameditor/diagrameditor";

const migrationConfig: ImportMigrationConfiguration = {
	pathMigrations: [{ from: `${packageName}/dist/**/*`, to: packageName }]
};

export const preferTopLevelImportsRecipe: Recipe = {
	metadata: {
		id: "prefer-top-level-imports",
		description: "Migrates Diagram Editor imports from deep paths to top-level namespace imports",
