...
export function assertContainerProperties(containerId: string, assertion: (container: DiagramContainer) => void) {
	assertDiagramState(diagramState => {
		assertion(diagramState.diagram.containers[containerId]);
	});
}
