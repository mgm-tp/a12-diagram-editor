...
function isPerformanceDiagramDataHolder(dh: Activity.DataHolder): dh is Activity.DataHolder {
	return dh.descriptor.diagram === "performance";
}

export const performanceDiagramActivityReducer: ActivityReducers.DataReducer = {
	reduce(dataHolders, action) {
		const dataHolder = dataHolders.find(isPerformanceDiagramDataHolder);
