...
export function DefaultPortWidget(props: PortWidgetProps) {
	return <DiagramPortWidget data-role={DEFAULT_PORT_TYPE} selected={props.hovered} readOnly={props.readonly} />;
}
