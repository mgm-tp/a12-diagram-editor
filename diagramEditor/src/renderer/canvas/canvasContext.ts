...
export type CanvasContext = {
	setOnMouseMove: (fn: MouseEventHandler | undefined) => void;
	setOnMouseUp: (fn: MouseEventHandler | undefined) => void;
	clear: () => void;
};
...
export function useCanvasContext(): CanvasContext {
	...
	assertExists(ctx, "useCanvasContext must be used inside <CanvasContext.Provider>");
	return ctx;
}
