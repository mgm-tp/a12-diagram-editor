...
export function ContainerLayer(props: ContainerLayerProps) {
	const { containerWidgetMap, portWidgetMap } = props;
	const container = useDiagramState(state => state.diagram.containers);
